...
def load_documents(data_dir: str | Path = "data") -> list[LoadedDocument]:
    """Backward-compatible wrapper for callers using the original API."""
    return load_corpus(Path(data_dir))
